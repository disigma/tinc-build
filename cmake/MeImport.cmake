function(me_try_import_project project name version search_dir)
  if(ME_STANDALONE)
    # TODO: Use pkg_check_modules to find the library and create imported
    # targets.
    message(FATAL_ERROR "Standalone projects are currently not supported.")
    return()
  endif()
  if(EXISTS ${search_dir}/CMakeLists.txt)
    get_filename_component(resolved_dir ${search_dir} REALPATH)
    add_subdirectory(${resolved_dir} ${CMAKE_BINARY_DIR}/${name}-${version})
    if(TARGET ${project})
...
function(me_import_project project)
  me_parse_project(${project} name subproject version)
  me_try_import_project(
    ${project} ${name} ${version} ${ME_ROOT_DIR}/${name}/${version}
  )
  me_try_import_project(
    ${project} ${name} ${version} ${ME_ROOT_DIR}/3rd/${name}/${version}
  )
